...
2. Database optimizations: 
   3. The cache can only be used currently on the `get_current_user` call. Define other cases.
   4. Connection pools
   5. Batch API calls
...
8. Install metrics service on the k8s cluster and configure a `HorizontalPodAutoscaler`